...
Далее был создан 3D проект в Unity. Стоимость проекта увеличилась на пустой объект и два пакета с библиотеками и звуками. Затем был создан скрипт, получающий из гугл-таблицы значения и анализирующий их. Теперь воспроизводящий звук выводит значение параметра (код ниже)
```py
